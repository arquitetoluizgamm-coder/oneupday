...
export const dictionaries = {
  ...
  pt: {
    ...
    musicAdd: '\u{1F3B5} M\u00fasica', musicTitle: 'Escolha uma m\u00fasica', musicUse: 'Usar', musicRemove: 'Remover', musicEmpty: 'Nada encontrado.', musicSearchPh: 'Buscar música…', musicKeyNeeded: 'Música ainda não configurada.', musicOfficial: 'Trilha oficial do ONE', musicClip: 'Escolha o trecho', musicStarts: 'Começa em', musicWhole: 'Música inteira', musicSeconds: 'Trecho de 30 segundos', musicVideoLength: 'O trecho acompanha a duração do vídeo', musicDone: 'Concluir',
