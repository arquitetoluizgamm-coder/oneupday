...
dictionaries.en.upiRecStarted = '{name} just started a journey. See how the first step is taking shape.';
dictionaries.en.upiRecHard = '{name} recorded a difficult day and kept the story open.';
dictionaries.en.upiRecMoving = '{name} is still moving through this journey.';
...
dictionaries.pt.upiRecStarted = '{name} acabou de começar uma jornada. Veja como esse primeiro passo está tomando forma.';
dictionaries.pt.upiRecHard = '{name} registrou um dia difícil e manteve a história aberta.';
...
SPANISH_CORE.upiRecStarted = '{name} acaba de comenzar una jornada. Mira cómo toma forma este primer paso.';
SPANISH_CORE.upiRecHard = '{name} registró un día difícil y mantuvo la historia abierta.';
