...
export const dictionaries = {
  en: {
    ...
    goalWord: 'Goal',
    withYouIdle: 'I\u2019m with you', withYouActive: 'With you', supporters: 'See who is with you', supportersLoading: 'Loading\u2026', supportersEmpty: 'You are the first to show up here.',
    ...
    messages: 'Messages', back: 'Back', messageSearch: 'Search a person by name or @handle', messageEmpty: 'No conversations yet.', messageChoose: 'Choose a conversation to start.', messageStart: 'Say something supportive to begin.', messagePlaceholder: 'Write a private message…', messageSend: 'Send', messageSending: 'Sending…', messageError: 'Could not send this message.', messageConnection: 'You can message people after one of you follows the other.', filterLabel: 'Filter', filterAll: 'All',
  ...
  pt: {
    ...
    goalWord: 'Meta',
    withYouIdle: 'Estou com você', withYouActive: 'Com você', supporters: 'Ver quem está com você', supportersLoading: 'Carregando\u2026', supportersEmpty: 'Você foi a primeira pessoa a aparecer aqui.',
