...
export const dictionaries = {
  ...
  pt: {
    ...
    chTitle: 'Desafios', chBtn: 'Desafiar', chModalTitle: 'Lançar um desafio', chWhat: 'O desafio', chPh: 'ex.: Tomar 2L de água por dia', chDays: '{d} dias', chSend: 'Enviar desafio', chSending: 'Enviando…', chSent: 'Desafio enviado. Agora é com {name}.', chErrExists: 'Vocês já têm um desafio aberto.', chErrConn: 'Desafios são entre pessoas que se seguem.', chErr: 'Não foi possível enviar. Tente de novo.', chInviteFrom: '{name} te desafiou', chAccept: 'Aceitar', chDecline: 'Recusar', chWaiting: 'Aguardando {name}…', chTogether: 'Caminhada junta · sem vencedor', chCheck: 'Fiz hoje', chChecked: 'Você marcou presença hoje', chPresence: '{n} de {d} dias', chDone: 'Desafio concluído. As duas histórias cresceram.', chOpen: 'Abrir', chPageEyebrow: 'Desafio', chEmpty: 'Desafie alguém a caminhar junto — abra o perfil de quem você segue e toque em Desafiar.', chStripTag: 'Desafio em andamento', chStripSee: 'acompanhar', notifChallenge: '{name} te lançou um desafio 🤝', notifChallengeAccept: '{name} aceitou seu desafio', ejErrTitle: 'O nome não pode ficar vazio.', profTabJourneys: 'Jornadas', profTabAlbum: 'Álbum', profTabPeople: 'Pessoas', albumEmpty: 'Suas fotos e vídeos moram aqui.', albumEmptyCta: 'Adicionar foto ou vídeo', mediaDelete: 'Excluir', mediaDeleteConfirm: 'Excluir esta foto? Não dá pra desfazer.', cropOriginal: 'Original', cropCover: 'Capa', cropSquare: 'Quadrado', cropPortrait: 'Retrato', cropLandscape: 'Paisagem', cropUse: 'Usar foto', cropEdit: 'Editar enquadramento', cropCancel: 'Cancelar', cropHint: 'Arraste para reposicionar · use o controle para dar zoom', cropHintOriginal: 'Foto inteira, sem cortar nada', cropZoom: 'Zoom',
