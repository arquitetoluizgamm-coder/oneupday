...
export const dictionaries = {
  en: {
    ...
    demoLabelDemo: 'See how a journey works',
    ...
    crisisText: 'If you\u2019re going through something really hard, talking to someone helps. Reach out to a local crisis line — in the US, call or text 988 (24/7). Posting here is welcome too, but please reach out for real support.',
  ...
  pt: {
    ...
    demoLabelDemo: 'Veja como uma jornada funciona',
    ...
    crisisText: 'Se você está passando por um momento muito difícil, falar com alguém ajuda. No Brasil, o CVV atende 24h, de graça, pelo 188 e em cvv.org.br. Postar aqui é bem-vindo, mas procure um apoio de verdade.',
