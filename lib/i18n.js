...
export const dictionaries = {
  en: {
    ...
    musicAdd: '\u{1F3B5} Music', musicTitle: 'Pick a track', musicUse: 'Use', musicRemove: 'Remove', musicEmpty: 'No results.', musicSearchPh: 'Search music…', musicKeyNeeded: 'Music not set up yet.', musicOfficial: 'ONE official soundtrack', musicClip: 'Choose the excerpt', musicStarts: 'Starts at', musicWhole: 'Entire track', musicSeconds: '15-second excerpt', musicVideoLength: 'Excerpt follows the video length', musicDone: 'Done',
  ...
  pt: {
    ...
    musicAdd: '\u{1F3B5} M\u00fasica', musicTitle: 'Escolha uma m\u00fasica', musicUse: 'Usar', musicRemove: 'Remover', musicEmpty: 'Nada encontrado.', musicSearchPh: 'Buscar música…', musicKeyNeeded: 'Música ainda não configurada.', musicOfficial: 'Trilha oficial do ONE', musicClip: 'Escolha o trecho', musicStarts: 'Começa em', musicWhole: 'Música inteira', musicSeconds: 'Trecho de 15 segundos', musicVideoLength: 'O trecho acompanha a duração do vídeo', musicDone: 'Concluir',
