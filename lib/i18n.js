...
export const dictionaries = {
  en: {
    ...
    wizT1: 'What do you want to change?', wizT2: 'What will you do?', wizS2: 'Describe one simple action.', wizT3: 'How many times a week?', wizT4: 'Your first day',
  ...
  pt: {
    ...
    wizT1: 'O que você quer mudar?', wizT2: 'O que você vai fazer?', wizS2: 'Descreva uma ação simples.', wizT3: 'Quantas vezes por semana?', wizT4: 'Seu primeiro dia',
