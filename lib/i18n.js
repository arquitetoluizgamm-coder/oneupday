...
//                              produto morto
// ============================================================
dictionaries.pt.cvTitulo = 'Você não precisa vencer tudo hoje.';
dictionaries.pt.cvSub = 'O ONE é uma rede social para quem acredita que continuar importa mais do que parecer perfeito.';
dictionaries.pt.cvComoFunciona = 'Todos os dias, pessoas registram pequenas vitórias, recomeços e jornadas reais. Continuar é progresso.';
dictionaries.pt.cvGradual = 'Estamos recebendo novos participantes em pequenos grupos, para acompanhar cada pessoa de perto.';
dictionaries.pt.cvPergunta = 'O que você gostaria de continuar?';
dictionaries.pt.cvPlaceholder = 'Voltar a correr. Parei há dois anos e nunca mais consegui começar.';
dictionaries.pt.cvSigilo = 'O que você escrever fica só entre nós.';
dictionaries.pt.cvOndeEncontro = 'Onde a gente te encontra?';
dictionaries.pt.cvEmailPh = 'seu@email.com';
dictionaries.pt.cvBotao = 'Guardar minha jornada';
...
dictionaries.pt.cvProntoTitulo = 'Sua jornada foi guardada.';
dictionaries.pt.cvProntoP1 = 'Obrigado por confiar esse começo ao ONE.';
dictionaries.pt.cvProntoP2 = 'Vou ler o que você escreveu e te responder nos próximos dias.';
dictionaries.pt.cvProntoP3 = 'Quando você entrar, a sua jornada estará esperando exatamente como você a escreveu hoje.';
...
dictionaries.en.cvTitulo = 'You don\u2019t have to win everything today.';
dictionaries.en.cvSub = 'ONE is a social network for people who believe that keeping going matters more than looking perfect.';
dictionaries.en.cvComoFunciona = 'Every day, people record small wins, fresh starts and real journeys. Continuing is progress.';
dictionaries.en.cvGradual = 'We are welcoming new participants in small groups, so we can stay close to each person.';
dictionaries.en.cvPergunta = 'What would you like to keep going with?';
dictionaries.en.cvPlaceholder = 'Get back to running. I stopped two years ago and never managed to start again.';
dictionaries.en.cvSigilo = 'What you write stays between us.';
dictionaries.en.cvOndeEncontro = 'Where do we find you?';
dictionaries.en.cvEmailPh = 'you@email.com';
dictionaries.en.cvBotao = 'Keep my journey safe';
...
dictionaries.en.cvProntoTitulo = 'Your journey has been kept safe.';
dictionaries.en.cvProntoP1 = 'Thank you for trusting this beginning to ONE.';
dictionaries.en.cvProntoP2 = 'I will read what you wrote and reply to you in the next few days.';
dictionaries.en.cvProntoP3 = 'When you come in, your journey will be waiting exactly as you wrote it today.';
...
SPANISH_CORE.cvTitulo = 'No tienes que ganarlo todo hoy.';
SPANISH_CORE.cvSub = 'ONE es una red social para quienes creen que continuar importa más que parecer perfecto.';
SPANISH_CORE.cvComoFunciona = 'Cada día, hay personas que registran pequeñas victorias, recomienzos y jornadas reales. Continuar es progreso.';
SPANISH_CORE.cvGradual = 'Estamos recibiendo nuevos participantes en grupos pequeños, para acompañar de cerca a cada persona.';
SPANISH_CORE.cvPergunta = '¿Qué te gustaría continuar?';
SPANISH_CORE.cvPlaceholder = 'Volver a correr. Lo dejé hace dos años y nunca logré empezar de nuevo.';
SPANISH_CORE.cvSigilo = 'Lo que escribas queda solo entre nosotros.';
SPANISH_CORE.cvOndeEncontro = '¿Dónde te encontramos?';
SPANISH_CORE.cvEmailPh = 'tu@email.com';
SPANISH_CORE.cvBotao = 'Guardar mi jornada';
...
SPANISH_CORE.cvProntoTitulo = 'Tu jornada fue guardada.';
SPANISH_CORE.cvProntoP1 = 'Gracias por confiarle este comienzo a ONE.';
SPANISH_CORE.cvProntoP2 = 'Voy a leer lo que escribiste y te responderé en los próximos días.';
SPANISH_CORE.cvProntoP3 = 'Cuando entres, tu jornada estará esperándote exactamente como la escribiste hoy.';
