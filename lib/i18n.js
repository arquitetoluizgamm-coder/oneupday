...
export const dictionaries = {
  ...
  pt: {
    ...
    goalWord: 'Meta',
    withYouIdle: 'Estou com você', withYouActive: 'Com você', supporters: 'Ver quem está com você', supportersLoading: 'Carregando\u2026', supportersEmpty: 'Você foi a primeira pessoa a aparecer aqui.', supportStrip: 'Com {name} nesta jornada', heartTitle: 'Enquanto você esteve fora', heartLikes: 'apoiaram você', heartFollows: 'começaram a te seguir', heartEmpty: 'Nada novo por aqui ainda.', heartSeeAll: 'Ver notificações', progressFmt: 'Dia {d} · faltam {r} para a meta', suggestTitle: 'Pessoas para apoiar', suggestSub: 'Comece a acompanhar quem também está tentando',
