...
export const dictionaries = {
  en: {
    ...
    mediaAdd: '+ Photo or video', mediaEyebrow: 'ADD', mediaTitle: 'Photo or video', mediaPick: 'Choose a photo or video', mediaReplace2: 'Change', mediaDest: 'Where does it go?', mediaDestJourney: 'Into a journey', mediaDestJourneySub: 'Adds it to a specific day', mediaDestAlbum: 'To my album', mediaDestAlbumSub: 'A personal gallery on your profile', mediaWhichJourney: 'Which journey', mediaWhichDay: 'Which day', mediaWhoSees: 'Who can see it', mediaSave: 'Add', albumTitle: 'Album',
