...
export const dictionaries = {
  en: {
    ...
    musicAdd: '\u{1F3B5} Music', musicTitle: 'Pick a track', musicUse: 'Use', musicRemove: 'Remove', musicEmpty: 'No results.', musicSearchPh: 'Search music…', musicKeyNeeded: 'Music not set up yet.', musicOfficial: 'ONE official soundtrack', musicClip: 'Choose the excerpt', musicStarts: 'Starts at', musicWhole: 'Entire track', musicSeconds: '30-second excerpt', musicVideoLength: 'Excerpt follows the video length', musicDone: 'Done', musicMixTitle: 'Sound balance', musicMixHint: 'Set the balance between the soundtrack and the original video audio.', musicTrackVolume: 'Music', musicVideoVolume: 'Video audio',
    ...
    trTag: 'Before & after', trDayFmt: 'Day {d}', trGap: '{n} days between the two', trSee: 'see the journey', amTitle: 'Tomorrow, the journey continues.', amComecou: '{name} started today', amTermina: '{name} finishes tomorrow', amChegou: '{name} reached day {t}', amMarco: '{name} reaches day {d} tomorrow', amDoneDay: 'Day {d} completed', amReachedDay: 'Reached day {d}', rtTitle: 'Came back this week', rtCame: '{name} came back after {d} days', rtCta: 'welcome them back', rtSent: 'sent 💛', 
    ...
    daysPosted: 'days posted', daysPostedOne: 'day posted', moreOptions: 'More options', focusFree: 'Free feed', focusPresence: 'Presence mode', startCta: 'Start my journey', recordsFmt: '{n} records this day',
    ...
    videoFill: 'Fill', videoFit: 'Fit', videoSoundOn: 'Turn video sound on', videoSoundOff: 'Mute video',
    ...
    allCats: 'All',
    explore: 'Explore',
    navHome: 'Home', navExplore: 'Explore', navCreate: 'New chapter', navToday: 'Log today’s day', navProfile: 'You', navSearch: 'Search', navMedia: 'Photo or video', navJourney: 'New journey', navCircles: 'Circles',
  ...
  pt: {
    ...
    musicAdd: '\u{1F3B5} M\u00fasica', musicTitle: 'Escolha uma m\u00fasica', musicUse: 'Usar', musicRemove: 'Remover', musicEmpty: 'Nada encontrado.', musicSearchPh: 'Buscar música…', musicKeyNeeded: 'Música ainda não configurada.', musicOfficial: 'Trilha oficial do ONE', musicClip: 'Escolha o trecho', musicStarts: 'Começa em', musicWhole: 'Música inteira', musicSeconds: 'Trecho de 30 segundos', musicVideoLength: 'O trecho acompanha a duração do vídeo', musicDone: 'Concluir', musicMixTitle: 'Equilíbrio do som', musicMixHint: 'Defina o equilíbrio entre a trilha e o áudio original do vídeo.', musicTrackVolume: 'Música', musicVideoVolume: 'Áudio do vídeo',
    ...
    trTag: 'Antes & depois', trDayFmt: 'Dia {d}', trGap: '{n} dias entre as duas', trSee: 'ver a jornada', amTitle: 'Amanhã, a jornada continua.', amComecou: '{name} começou hoje', amTermina: '{name} termina amanhã', amChegou: '{name} chegou ao dia {t}', amMarco: '{name} chega ao dia {d} amanhã', amDoneDay: 'Dia {d} concluído', amReachedDay: 'Chegou ao dia {d}', rtTitle: 'Voltaram esta semana', rtCame: '{name} voltou depois de {d} dias', rtCta: 'dar as boas-vindas', rtSent: 'enviado 💛', 
    ...
    daysPosted: 'dias postados', daysPostedOne: 'dia postado', moreOptions: 'Mais opções', focusFree: 'Feed livre', focusPresence: 'Modo presença', startCta: 'Começar minha jornada', recordsFmt: '{n} registros neste dia',
    ...
    videoFill: 'Preencher', videoFit: 'Ajustar', videoSoundOn: 'Ativar som do vídeo', videoSoundOff: 'Silenciar vídeo',
    ...
    allCats: 'Todas',
    explore: 'Explorar',
    navHome: 'Início', navExplore: 'Explorar', navCreate: 'Criar capítulo', navToday: 'Registrar o dia de hoje', navProfile: 'Você', navSearch: 'Buscar', navMedia: 'Foto ou vídeo', navJourney: 'Nova jornada', navCircles: 'Círculos',
...
const SPANISH_CORE = {
  ...
  navHome: 'Inicio', navExplore: 'Explorar', navCreate: 'Crear jornada', navToday: 'Registrar hoy', navProfile: 'Tú', navSearch: 'Buscar', navMedia: 'Foto o vídeo', navJourney: 'Nueva jornada', navCircles: 'Círculos',
  ...
  dayShort: 'Día {d}', dayOfShort: 'Día {d} / {t}', moreOptions: 'Más opciones', focusFree: 'Feed libre', focusPresence: 'Modo presencia', moreText: 'más', lessText: 'menos',
  ...
  amTitle: 'Mañana, la jornada continúa.', amComecou: '{name} comenzó hoy', amTermina: '{name} termina mañana', amChegou: '{name} llegó al día {t}', amMarco: '{name} llega al día {d} mañana', amDoneDay: 'Día {d} concluido', amReachedDay: 'Llegó al día {d}',
  ...
  videoFill: 'Rellenar', videoFit: 'Ver completo', videoSoundOn: 'Activar sonido del video', videoSoundOff: 'Silenciar video',
  ...
  musicAdd: '🎵 Música', musicTitle: 'Elegir una canción', musicUse: 'Usar', musicRemove: 'Quitar', musicEmpty: 'No hay resultados.', musicSearchPh: 'Buscar música…', musicKeyNeeded: 'La música todavía no está configurada.', musicOfficial: 'Banda sonora oficial de ONE', musicClip: 'Elige el fragmento', musicStarts: 'Comienza en', musicWhole: 'Canción completa', musicSeconds: 'Fragmento de 30 segundos', musicVideoLength: 'El fragmento sigue la duración del video', musicDone: 'Listo', musicMixTitle: 'Equilibrio del sonido', musicMixHint: 'Define el equilibrio entre la música y el audio original del video.', musicTrackVolume: 'Música', musicVideoVolume: 'Audio del video',
...
// /invite — O COFRE
//
// Textos discutidos linha a linha. O que NAO esta aqui foi cortado
// de proposito:
//
//   "voce foi convidado" ..... falso numa pagina publica
//   "vagas limitadas" ........ competicao; e competicao e o que fez
//                              essa pessoa parar de postar
//   "nao para impressionar" .. nomear a objecao e planta-la, e
//                              "impressionar" e a palavra que ela
//                              carrega
//   contador de pessoas ...... inventado seria a contradicao mais
//                              cara possivel; real e pequeno le como
//                              produto morto
// ============================================================
dictionaries.pt.cvTitulo = 'Antes de entrar, escreva o seu começo.';
dictionaries.pt.cvSub = 'O ONE guarda uma intenção sua antes de pedir cadastro. Uma frase basta.';
dictionaries.pt.cvComoFunciona = 'Quando sua entrada for liberada, essa frase vira o primeiro rascunho da sua jornada. Você poderá editar, publicar ou guardar só para você.';
dictionaries.pt.cvGradual = 'Estamos chamando pessoas em pequenos grupos para cuidar da experiência de perto.';
dictionaries.pt.cvPergunta = 'Qual começo você quer guardar?';
dictionaries.pt.cvPlaceholder = 'Voltar a treinar sem me cobrar perfeição. Quero começar pequeno e continuar.';
dictionaries.pt.cvSigilo = 'Ainda não é post. Fica guardado no cofre do ONE.';
dictionaries.pt.cvOndeEncontro = 'Para onde a Upi pode te avisar?';
dictionaries.pt.cvEmailPh = 'seu@email.com';
dictionaries.pt.cvBotao = 'Guardar meu começo';
dictionaries.pt.cvEnviando = 'Guardando\u2026';
dictionaries.pt.cvErroEmail = 'Esse e-mail parece incompleto. Confere pra mim?';
dictionaries.pt.cvErroGeral = 'Não consegui guardar agora. Tenta de novo em instantes.';
dictionaries.pt.cvGuardadaSelo = 'Guardada';
dictionaries.pt.cvCardTopo = 'Sua jornada';
dictionaries.pt.cvCardPe = 'Ainda não publicada. Ninguém vê além de você.';
dictionaries.pt.cvProntoTitulo = 'Seu começo ficou guardado.';
dictionaries.pt.cvProntoP1 = 'Essa frase ainda não está pública. Ela ficou salva como uma intenção sua.';
dictionaries.pt.cvProntoP2 = 'Quando sua entrada for liberada, você recebe o caminho para continuar de onde começou.';
dictionaries.pt.cvProntoP3 = 'Se quiser, depois você transforma isso em jornada, diário privado ou cápsula para o futuro.';
dictionaries.pt.cvProntoSo = 'Até lá, ela continua sendo somente sua.';
dictionaries.pt.cvVoltaSelo = 'Ela esperou por você';
dictionaries.pt.cvVoltaTitulo = 'Sua jornada está aqui.';
dictionaries.pt.cvVoltaP = 'Do jeito que você escreveu. Agora é só começar.';
dictionaries.pt.cvVoltaCta = 'Começar minha jornada';

dictionaries.en.cvTitulo = 'Before you join, write down your beginning.';
dictionaries.en.cvSub = 'ONE keeps one intention before asking you to sign up. One sentence is enough.';
dictionaries.en.cvComoFunciona = 'When your access opens, this sentence becomes the first draft of your journey. You can edit it, publish it, or keep it private.';
dictionaries.en.cvGradual = 'We are inviting people in small groups so we can shape the experience with care.';
dictionaries.en.cvPergunta = 'What beginning do you want to keep?';
dictionaries.en.cvPlaceholder = 'Get back to training without demanding perfection. I want to start small and keep going.';
dictionaries.en.cvSigilo = 'This is not a post yet. It stays in ONE\u2019s vault.';
dictionaries.en.cvOndeEncontro = 'Where can Upi let you know?';
dictionaries.en.cvEmailPh = 'you@email.com';
dictionaries.en.cvBotao = 'Keep my beginning';
dictionaries.en.cvEnviando = 'Saving\u2026';
dictionaries.en.cvErroEmail = 'That email looks incomplete. Mind checking?';
dictionaries.en.cvErroGeral = 'I could not save it right now. Try again in a moment.';
dictionaries.en.cvGuardadaSelo = 'Kept safe';
dictionaries.en.cvCardTopo = 'Your journey';
dictionaries.en.cvCardPe = 'Not published yet. Nobody sees it but you.';
dictionaries.en.cvProntoTitulo = 'Your beginning is safe.';
dictionaries.en.cvProntoP1 = 'This sentence is not public. It was saved as your private intention.';
dictionaries.en.cvProntoP2 = 'When your access opens, you will receive a path to continue from here.';
dictionaries.en.cvProntoP3 = 'Later, you can turn it into a journey, a private diary entry, or a time capsule.';
dictionaries.en.cvProntoSo = 'Until then, it stays only yours.';
dictionaries.en.cvVoltaSelo = 'It waited for you';
dictionaries.en.cvVoltaTitulo = 'Your journey is here.';
dictionaries.en.cvVoltaP = 'Exactly as you wrote it. Now you just have to begin.';
dictionaries.en.cvVoltaCta = 'Start my journey';

SPANISH_CORE.cvTitulo = 'Antes de entrar, escribe tu comienzo.';
SPANISH_CORE.cvSub = 'ONE guarda una intención tuya antes de pedirte registro. Una frase basta.';
SPANISH_CORE.cvComoFunciona = 'Cuando tu acceso se abra, esa frase será el primer borrador de tu jornada. Podrás editarla, publicarla o guardarla en privado.';
SPANISH_CORE.cvGradual = 'Estamos invitando personas en grupos pequeños para cuidar la experiencia de cerca.';
SPANISH_CORE.cvPergunta = '¿Qué comienzo quieres guardar?';
SPANISH_CORE.cvPlaceholder = 'Volver a entrenar sin exigirme perfección. Quiero empezar pequeño y continuar.';
SPANISH_CORE.cvSigilo = 'Todavía no es una publicación. Queda guardado en el cofre de ONE.';
SPANISH_CORE.cvOndeEncontro = '¿Dónde puede avisarte Upi?';
SPANISH_CORE.cvEmailPh = 'tu@email.com';
SPANISH_CORE.cvBotao = 'Guardar mi comienzo';
SPANISH_CORE.cvEnviando = 'Guardando\u2026';
SPANISH_CORE.cvErroEmail = 'Ese correo parece incompleto. ¿Lo revisas?';
SPANISH_CORE.cvErroGeral = 'No pude guardarla ahora. Inténtalo en un momento.';
SPANISH_CORE.cvGuardadaSelo = 'Guardada';
SPANISH_CORE.cvCardTopo = 'Tu jornada';
SPANISH_CORE.cvCardPe = 'Todavía no publicada. Nadie la ve más que tú.';
SPANISH_CORE.cvProntoTitulo = 'Tu comienzo quedó guardado.';
SPANISH_CORE.cvProntoP1 = 'Esta frase no es pública. Quedó guardada como una intención tuya.';
SPANISH_CORE.cvProntoP2 = 'Cuando tu acceso se abra, recibirás el camino para continuar desde aquí.';
SPANISH_CORE.cvProntoP3 = 'Después podrás convertirlo en jornada, diario privado o cápsula para el futuro.';
SPANISH_CORE.cvProntoSo = 'Hasta entonces, sigue siendo solo tuya.';
SPANISH_CORE.cvVoltaSelo = 'Te esperó';
SPANISH_CORE.cvVoltaTitulo = 'Tu jornada está aquí.';
SPANISH_CORE.cvVoltaP = 'Tal como la escribiste. Ahora solo falta empezar.';
SPANISH_CORE.cvVoltaCta = 'Empezar mi jornada';

dictionaries.pt.cvVoltouTitulo = 'Sua jornada continua guardada.';
dictionaries.pt.cvVoltouNota = 'Quer mudar o que escreveu? É só me dizer quando eu te responder.';
dictionaries.en.cvVoltouTitulo = 'Your journey is still kept safe.';
dictionaries.en.cvVoltouNota = 'Want to change what you wrote? Just tell me when I reply to you.';
SPANISH_CORE.cvVoltouTitulo = 'Tu jornada sigue guardada.';
SPANISH_CORE.cvVoltouNota = '¿Quieres cambiar lo que escribiste? Dímelo cuando te responda.';

dictionaries.pt.notifConvite = 'Alguém guardou uma jornada no convite. Vale ler e responder.';
dictionaries.en.notifConvite = 'Someone kept a journey safe on the invite page. Worth reading and replying.';
SPANISH_CORE.notifConvite = 'Alguien guardó una jornada en la invitación. Vale la pena leer y responder.';
...
Object.assign(dictionaries.en, {
  ...
  amSub: 'Today, these people took another step.',
...
Object.assign(dictionaries.pt, {
  ...
  amSub: 'Hoje, essas pessoas deram mais um passo.',
...
Object.assign(SPANISH_CORE, {
  ...
  amSub: 'Hoy, estas personas dieron un paso más.',
...
dictionaries.en.homeWelcomeNewSub = 'Everyone has a journey. Something to face, change, or solve. Yours can begin today.';
dictionaries.pt.homeWelcomeNewSub = 'Todo mundo tem uma jornada. Algo para enfrentar, mudar ou resolver. A sua pode começar hoje.';
...
dictionaries.en.upiMemoryTitle = 'Can I ask you one thing?';
dictionaries.en.upiMemorySub = 'Upi keeps one private memory a day, so your story does not restart from zero.';
dictionaries.en.upiMemoryPh = 'Answer freely. Only you can see this.';
dictionaries.en.upiMemorySave = 'Save memory';
dictionaries.en.upiMemoryUpdate = 'Update memory';
dictionaries.en.upiMemorySaving = 'Saving...';
dictionaries.en.upiMemorySaved = 'Upi saved this.';
dictionaries.en.upiMemoryListTitle = 'What Upi remembers';
dictionaries.pt.upiMemoryTitle = 'Posso te fazer uma pergunta?';
dictionaries.pt.upiMemorySub = 'A Upi guarda uma memoria privada por dia, para sua historia nao recomecar do zero.';
dictionaries.pt.upiMemoryPh = 'Responda do seu jeito. So voce ve isso.';
dictionaries.pt.upiMemorySave = 'Guardar memoria';
dictionaries.pt.upiMemoryUpdate = 'Atualizar memoria';
dictionaries.pt.upiMemorySaving = 'Guardando...';
dictionaries.pt.upiMemorySaved = 'A Upi guardou isso.';
dictionaries.pt.upiMemoryListTitle = 'O que a Upi lembra';
SPANISH_CORE.upiMemoryTitle = 'Puedo hacerte una pregunta?';
SPANISH_CORE.upiMemorySub = 'Upi guarda una memoria privada por dia, para que tu historia no empiece de cero.';
SPANISH_CORE.upiMemoryPh = 'Responde a tu manera. Solo tu puedes ver esto.';
SPANISH_CORE.upiMemorySave = 'Guardar memoria';
SPANISH_CORE.upiMemoryUpdate = 'Actualizar memoria';
SPANISH_CORE.upiMemorySaving = 'Guardando...';
SPANISH_CORE.upiMemorySaved = 'Upi guardo esto.';
SPANISH_CORE.upiMemoryListTitle = 'Lo que Upi recuerda';
dictionaries.en.feedStoryBack = '{name} came back after {d} days.';
dictionaries.en.feedStoryMilestone = '{name} reached Day {d}.';
dictionaries.en.feedStoryStart = '{name} started a new journey.';
dictionaries.en.feedStoryHard = '{name} registered a difficult day and still continued.';
dictionaries.en.feedStoryNext = '{name} left a small step for tomorrow.';
dictionaries.en.feedStoryPhoto = '{name} shared a moment from the journey.';
dictionaries.en.feedStoryDefault = '{name} showed up today.';
dictionaries.en.upiRecTitle = 'A journey worth following';
dictionaries.en.upiRecStarted = '{name} started a new journey.';
dictionaries.en.upiRecHard = '{name} kept the story open on a hard day.';
dictionaries.en.upiRecMoving = '{name} is moving through this journey.';
dictionaries.en.upiRecDay = 'Day {d} of {t}';
dictionaries.pt.feedStoryBack = '{name} voltou depois de {d} dias.';
dictionaries.pt.feedStoryMilestone = '{name} chegou ao Dia {d}.';
dictionaries.pt.feedStoryStart = '{name} começou uma nova jornada.';
dictionaries.pt.feedStoryHard = '{name} registrou um dia difícil e continuou.';
dictionaries.pt.feedStoryNext = '{name} deixou um passo pequeno para amanhã.';
dictionaries.pt.feedStoryPhoto = '{name} compartilhou um momento da jornada.';
dictionaries.pt.feedStoryDefault = '{name} apareceu hoje.';
dictionaries.pt.upiRecTitle = 'Uma jornada para acompanhar';
dictionaries.pt.upiRecStarted = '{name} começou uma nova jornada.';
dictionaries.pt.upiRecHard = '{name} manteve a história aberta em um dia difícil.';
dictionaries.pt.upiRecMoving = '{name} continua caminhando nesta jornada.';
dictionaries.pt.upiRecDay = 'Dia {d} de {t}';
SPANISH_CORE.feedStoryBack = '{name} volvió después de {d} días.';
SPANISH_CORE.feedStoryMilestone = '{name} llegó al Día {d}.';
SPANISH_CORE.feedStoryStart = '{name} comenzó una nueva jornada.';
SPANISH_CORE.feedStoryHard = '{name} registró un día difícil y aun así continuó.';
SPANISH_CORE.feedStoryNext = '{name} dejó un pequeño paso para mañana.';
SPANISH_CORE.feedStoryPhoto = '{name} compartió un momento de la jornada.';
SPANISH_CORE.feedStoryDefault = '{name} apareció hoy.';
SPANISH_CORE.upiRecTitle = 'Una jornada para acompañar';
SPANISH_CORE.upiRecStarted = '{name} empezó una nueva jornada.';
SPANISH_CORE.upiRecHard = '{name} mantuvo la historia abierta en un día difícil.';
SPANISH_CORE.upiRecMoving = '{name} sigue avanzando en esta jornada.';
SPANISH_CORE.upiRecDay = 'Día {d} de {t}';
...
dictionaries.es.homeWelcomeNewSub = 'Todos tienen una jornada. Algo que enfrentar, cambiar o resolver. La tuya puede empezar hoy.';
...
dictionaries.pt.cvProofLabel = 'O que acontece depois';
dictionaries.pt.cvProof1 = 'A Upi guarda sua frase como um começo privado.';
dictionaries.pt.cvProof2 = 'Quando você entrar, ela vira um rascunho editável.';
dictionaries.pt.cvProof3 = 'Você decide se publica, guarda no diário ou transforma em cápsula.';
dictionaries.pt.cvProofFoot = 'Nada vai para o feed sem a sua escolha.';

dictionaries.en.cvProofLabel = 'What happens next';
dictionaries.en.cvProof1 = 'Upi keeps your sentence as a private beginning.';
dictionaries.en.cvProof2 = 'When you come in, it becomes an editable draft.';
dictionaries.en.cvProof3 = 'You choose whether to publish it, keep it in your diary, or turn it into a capsule.';
dictionaries.en.cvProofFoot = 'Nothing goes to the feed without your choice.';

dictionaries.es.cvProofLabel = 'Qué pasa después';
dictionaries.es.cvProof1 = 'Upi guarda tu frase como un comienzo privado.';
dictionaries.es.cvProof2 = 'Cuando entres, se convierte en un borrador editable.';
dictionaries.es.cvProof3 = 'Tú decides si la publicas, la guardas en el diario o la conviertes en cápsula.';
dictionaries.es.cvProofFoot = 'Nada va al feed sin tu elección.';

dictionaries.pt.homeWelcomeMemoryNew = 'O primeiro valor do ONE não é ser visto. É não perder de vista quem você está tentando se tornar.';
dictionaries.pt.homeWelcomeMemoryBack = 'A Upi lembra por que você começou. Hoje só precisa existir um próximo passo.';
dictionaries.pt.homeWelcomeMemoryDone = 'O dia ficou guardado. Agora sua história ganhou mais uma prova de presença.';
dictionaries.pt.homeWelcomeRitualLabel = 'Rituais pessoais do ONE';
dictionaries.pt.navTree = 'Árvore';
dictionaries.pt.navFuture = 'Futuro';

dictionaries.en.homeWelcomeMemoryNew = 'ONE is not first about being seen. It is about not losing sight of who you are trying to become.';
dictionaries.en.homeWelcomeMemoryBack = 'Upi remembers why you started. Today only needs one next step.';
dictionaries.en.homeWelcomeMemoryDone = 'The day is saved. Your story gained one more proof of presence.';
dictionaries.en.homeWelcomeRitualLabel = 'ONE personal rituals';
dictionaries.en.navTree = 'Tree';
dictionaries.en.navFuture = 'Future';

dictionaries.es.homeWelcomeMemoryNew = 'ONE no empieza por ser visto. Empieza por no perder de vista en quién intentas convertirte.';
dictionaries.es.homeWelcomeMemoryBack = 'Upi recuerda por qué empezaste. Hoy solo necesita existir un próximo paso.';
dictionaries.es.homeWelcomeMemoryDone = 'El día quedó guardado. Tu historia ganó una prueba más de presencia.';
dictionaries.es.homeWelcomeRitualLabel = 'Rituales personales de ONE';
dictionaries.es.navTree = 'Árbol';
dictionaries.es.navFuture = 'Futuro';

dictionaries.pt.dayRegisterTitle = 'Vamos guardar o seu dia?';
dictionaries.pt.dayRegisterSub = 'Escolha como foi, conte em uma frase e só então publique.';
dictionaries.pt.dayPicked = 'Escolhido: {kind}. Agora conte em uma frase.';
dictionaries.pt.dayChooseFirst = 'Primeiro escolha como foi o seu dia.';
dictionaries.pt.dayPost = 'Guardar meu dia';
dictionaries.pt.draftSaved = 'Rascunho salvo';
dictionaries.pt.extraShow = 'Adicionar foto, vídeo, música ou ajuda';
dictionaries.pt.extraHide = 'Esconder opções';

dictionaries.en.dayRegisterTitle = 'Shall we keep your day?';
dictionaries.en.dayRegisterSub = 'Choose how it went, write one sentence, then decide to publish.';
dictionaries.en.dayPicked = 'Chosen: {kind}. Now tell it in one sentence.';
dictionaries.en.dayChooseFirst = 'First choose how your day went.';
dictionaries.en.dayPost = 'Save my day';
dictionaries.en.draftSaved = 'Draft saved';
dictionaries.en.extraShow = 'Add photo, video, music or help';
dictionaries.en.extraHide = 'Hide options';

dictionaries.es.dayRegisterTitle = '¿Guardamos tu día?';
dictionaries.es.dayRegisterSub = 'Elige cómo fue, cuenta una frase y después publica.';
dictionaries.es.dayPicked = 'Elegido: {kind}. Ahora cuéntalo en una frase.';
dictionaries.es.dayChooseFirst = 'Primero elige cómo fue tu día.';
dictionaries.es.dayPost = 'Guardar mi día';
dictionaries.es.draftSaved = 'Borrador guardado';
dictionaries.es.extraShow = 'Agregar foto, vídeo, música o ayuda';
dictionaries.es.extraHide = 'Ocultar opciones';

dictionaries.pt.jdConfigHint = 'Opcional. Abra só se quiser mudar detalhes.';
dictionaries.en.jdConfigHint = 'Optional. Open only if you want to change details.';
dictionaries.es.jdConfigHint = 'Opcional. Ábrelo solo si quieres cambiar detalles.';

dictionaries.pt.tomorrowTitle = 'Antes de sair, deixe um passo para amanhã.';
dictionaries.pt.tomorrowSub = 'Pequeno mesmo. A Upi guarda para você continuar sem recomeçar do zero.';
dictionaries.pt.tomorrowPh = 'Ex.: caminhar 10 minutos, abrir o caderno, beber água ao acordar...';
dictionaries.pt.tomorrowSave = 'Guardar para amanhã';
dictionaries.pt.tomorrowSaving = 'Guardando...';
dictionaries.pt.tomorrowSkip = 'Agora não';
dictionaries.pt.tomorrowSavedTitle = 'Pronto. Amanhã tem um começo esperando.';
dictionaries.pt.tomorrowSavedSub = 'Quando você voltar, a Upi lembra deste passo.';
dictionaries.pt.tomorrowError = 'Não consegui guardar agora. Tenta de novo em instantes.';

dictionaries.en.tomorrowTitle = 'Before you leave, set one step for tomorrow.';
dictionaries.en.tomorrowSub = 'Make it small. Upi keeps it so you can continue without starting over.';
dictionaries.en.tomorrowPh = 'Ex.: walk for 10 minutes, open the notebook, drink water after waking up...';
dictionaries.en.tomorrowSave = 'Keep for tomorrow';
dictionaries.en.tomorrowSaving = 'Saving...';
dictionaries.en.tomorrowSkip = 'Not now';
dictionaries.en.tomorrowSavedTitle = 'Done. Tomorrow has a beginning waiting.';
dictionaries.en.tomorrowSavedSub = 'When you come back, Upi remembers this step.';
dictionaries.en.tomorrowError = 'I could not save it right now. Try again in a moment.';

dictionaries.es.tomorrowTitle = 'Antes de salir, deja un paso para mañana.';
dictionaries.es.tomorrowSub = 'Que sea pequeño. Upi lo guarda para que puedas continuar sin empezar de cero.';
dictionaries.es.tomorrowPh = 'Ej.: caminar 10 minutos, abrir el cuaderno, beber agua al despertar...';
dictionaries.es.tomorrowSave = 'Guardar para mañana';
dictionaries.es.tomorrowSaving = 'Guardando...';
dictionaries.es.tomorrowSkip = 'Ahora no';
dictionaries.es.tomorrowSavedTitle = 'Listo. Mañana hay un comienzo esperándote.';
dictionaries.es.tomorrowSavedSub = 'Cuando vuelvas, Upi recuerda este paso.';
dictionaries.es.tomorrowError = 'No pude guardarlo ahora. Inténtalo en un momento.';

dictionaries.pt.upiPolishTitle = 'Quer deixar esse registro mais claro?';
dictionaries.pt.upiPolishSub = 'A Upi sugere versões melhores. Você escolhe, edita ou mantém o seu texto.';
dictionaries.pt.upiPolishBtn = 'Melhorar com a Upi';

dictionaries.en.upiPolishTitle = 'Want to make this post clearer?';
dictionaries.en.upiPolishSub = 'Upi suggests better versions. You choose, edit, or keep your own text.';
dictionaries.en.upiPolishBtn = 'Improve with Upi';

dictionaries.es.upiPolishTitle = '¿Quieres que este registro quede más claro?';
dictionaries.es.upiPolishSub = 'Upi sugiere mejores versiones. Tú eliges, editas o mantienes tu texto.';
dictionaries.es.upiPolishBtn = 'Mejorar con Upi';

dictionaries.pt.moodFeed = {
  down: 'ânimo baixo',
  anxious: 'ansiedade',
  angry: 'raiva',
  tired: 'cansaço',
...
dictionaries.pt.moodLineFmt = 'Sentindo {mood} hoje';
dictionaries.en.moodLineFmt = 'Feeling {mood} today';
dictionaries.es.moodLineFmt = 'Sintiendo {mood} hoy';
dictionaries.pt.journeyStatusFmt = 'Jornada em andamento · {day}';
dictionaries.en.journeyStatusFmt = 'Journey in progress · {day}';
dictionaries.es.journeyStatusFmt = 'Jornada en curso · {day}';
dictionaries.pt.homeWelcomeBackLead = 'Todo mundo tem uma jornada. Algo para enfrentar, mudar ou resolver. Hoje pode ser o começo da sua.';
dictionaries.en.homeWelcomeBackLead = 'Everyone has a journey. Something to face, change, or solve. Today can be the beginning of yours.';
dictionaries.es.homeWelcomeBackLead = 'Todos tienen una jornada. Algo que enfrentar, cambiar o resolver. Hoy puede ser el comienzo de la tuya.';
dictionaries.pt.homeWelcomeBackLead = 'Não precisa fazer muito. Escolha uma jornada e registre o passo que coube no seu dia.';
dictionaries.en.homeWelcomeBackLead = 'You do not need to do much. Choose a journey and log the step that fit your day.';
dictionaries.es.homeWelcomeBackLead = 'No necesitas hacer mucho. Elige una jornada y registra el paso que cupo en tu día.';
dictionaries.pt.homeWelcomeBackSub = dictionaries.pt.homeWelcomeBackLead;
dictionaries.en.homeWelcomeBackSub = dictionaries.en.homeWelcomeBackLead;
dictionaries.es.homeWelcomeBackSub = dictionaries.es.homeWelcomeBackLead;
dictionaries.pt.homeWelcomeRegister = 'Registrar meu dia';
dictionaries.en.homeWelcomeRegister = 'Log my day';
dictionaries.es.homeWelcomeRegister = 'Registrar mi día';
dictionaries.pt.homeWelcomeDiaryWrite = 'Escrever no diário privado';
dictionaries.en.homeWelcomeDiaryWrite = 'Write in my private diary';
dictionaries.es.homeWelcomeDiaryWrite = 'Escribir en el diario privado';
dictionaries.pt.homeWelcomeNewTitle = 'Você ainda não começou uma jornada.';
dictionaries.en.homeWelcomeNewTitle = 'You have not started a journey yet.';
dictionaries.es.homeWelcomeNewTitle = 'Todavía no empezaste una jornada.';
dictionaries.pt.homeWelcomeNewSub = 'Escolha algo que deseja enfrentar, mudar ou construir.';
dictionaries.en.homeWelcomeNewSub = 'Choose something you want to face, change, or build.';
dictionaries.es.homeWelcomeNewSub = 'Elige algo que quieras enfrentar, cambiar o construir.';
dictionaries.en.needsCta = 'Leave support';
dictionaries.pt.needsCta = 'Deixar um apoio';
dictionaries.es.needsCta = 'Dejar apoyo';
dictionaries.en.needsContext = 'They may need a little presence today.';
dictionaries.pt.needsContext = 'Pode estar precisando de uma presença hoje.';
dictionaries.es.needsContext = 'Puede estar necesitando un poco de presencia hoy.';
dictionaries.en.trTag = 'Before and after';
dictionaries.pt.trTag = 'Antes e depois';
dictionaries.es.trTag = 'Antes y después';
dictionaries.en.trGap = '{n} days between these two chapters';
dictionaries.pt.trGap = '{n} dias entre esses dois capítulos';
dictionaries.es.trGap = '{n} días entre estos dos capítulos';
dictionaries.en.trGapOne = '1 day between these two chapters';
dictionaries.pt.trGapOne = '1 dia entre esses dois capítulos';
dictionaries.es.trGapOne = '1 día entre estos dos capítulos';
dictionaries.en.trSee = 'See the journey';
dictionaries.pt.trSee = 'Ver a jornada';
dictionaries.es.trSee = 'Ver la jornada';
dictionaries.en.moodFeed = {
  down: 'low',
  anxious: 'anxiety',
  angry: 'anger',
  tired: 'tired',
...
dictionaries.pt.landHeadline = 'Você não precisa vencer tudo hoje.';
dictionaries.pt.landSub = 'Só precisa dar o próximo passo.';
dictionaries.pt.heroDesc = 'Crie uma jornada, registre um passo por dia e encontre pessoas que acompanham o caminho, não só o resultado.';
dictionaries.pt.landCta = 'Começar minha jornada';
dictionaries.pt.heroOnde = 'Funciona no navegador e no celular.';
dictionaries.pt.landEmotionTitle = 'Todo mundo tem uma jornada.';
dictionaries.pt.landEmotionSub = 'Algo para enfrentar, mudar ou resolver.';
dictionaries.pt.landEmotionCopy = 'Às vezes, só precisa de um motivo para começar e de um lugar onde o primeiro passo também importa.';
dictionaries.pt.landCloseKicker = 'Não importa o que você precisa enfrentar, mudar ou resolver.';
dictionaries.pt.landCloseSoft = 'Você não precisa ter tudo planejado.';
dictionaries.pt.landCloseStep = 'Só precisa dar o primeiro passo.';
dictionaries.pt.landCloseMemory = 'Daqui a cinco anos, você vai lembrar do dia em que começou.';
dictionaries.pt.landClose1 = 'Esse dia pode ser hoje.';
dictionaries.pt.landCloseCta = 'Começar minha jornada';

dictionaries.en.landHeadline = 'You do not have to win everything today.';
dictionaries.en.landSub = 'You just need to take the next step.';
dictionaries.en.heroDesc = 'Create a journey, record one step a day, and find people who follow the path, not just the result.';
dictionaries.en.landCta = 'Start my journey';
dictionaries.en.heroOnde = 'Works on browser and mobile.';
dictionaries.en.landEmotionTitle = 'Everyone has a journey.';
dictionaries.en.landEmotionSub = 'Something to face, change, or solve.';
dictionaries.en.landEmotionCopy = 'Sometimes, you only need a reason to begin and a place where the first step matters too.';
dictionaries.en.landCloseKicker = 'No matter what you need to face, change, or solve.';
dictionaries.en.landCloseSoft = 'You do not need to have everything planned.';
dictionaries.en.landCloseStep = 'You only need to take the first step.';
dictionaries.en.landCloseMemory = 'Five years from now, you will remember the day you started.';
dictionaries.en.landClose1 = 'That day can be today.';
dictionaries.en.landCloseCta = 'Start my journey';

dictionaries.es.landHeadline = 'No tienes que ganarlo todo hoy.';
dictionaries.es.landSub = 'Solo necesitas dar el próximo paso.';
dictionaries.es.heroDesc = 'Crea una jornada, registra un paso por día y encuentra personas que acompañan el camino, no solo el resultado.';
dictionaries.es.landCta = 'Comenzar mi jornada';
dictionaries.es.heroOnde = 'Funciona en navegador y celular.';
dictionaries.es.landEmotionTitle = 'Todos tienen una jornada.';
dictionaries.es.landEmotionSub = 'Algo que enfrentar, cambiar o resolver.';
dictionaries.es.landEmotionCopy = 'A veces, solo hace falta un motivo para empezar y un lugar donde el primer paso también importe.';
dictionaries.es.landCloseKicker = 'No importa lo que necesitas enfrentar, cambiar o resolver.';
dictionaries.es.landCloseSoft = 'No necesitas tener todo planeado.';
dictionaries.es.landCloseStep = 'Solo necesitas dar el primer paso.';
dictionaries.es.landCloseMemory = 'Dentro de cinco años, recordarás el día en que empezaste.';
dictionaries.es.landClose1 = 'Ese día puede ser hoy.';
dictionaries.es.landCloseCta = 'Comenzar mi jornada';

Object.assign(dictionaries.pt, {
  navBible: 'Mensagem bíblica',
  bibleEyebrow: 'UMA PALAVRA PARA O SEU DIA',
  bibleTitle: 'Mensagem bíblica de hoje para você',
  bibleSub: 'Uma passagem explicada em linguagem simples, sem reproduzir o texto bíblico.',
  bibleCardLabel: 'Mensagem bíblica para hoje',
  bibleTodayLabel: 'Para levar para hoje',
  bibleNoQuote: 'Sentido explicado · sem reprodução do versículo',
  bibleNoQuoteLong: 'Esta mensagem explica o sentido da passagem e informa a referência. O texto bíblico não é reproduzido.',
  bibleLoading: 'Preparando sua mensagem de hoje',
  bibleLoadingSub: 'A referência permanece fiel; o significado será explicado com cuidado e sem promessas fáceis.',
  bibleLoadError: 'Não foi possível preparar a mensagem agora.',
  bibleSaveError: 'Não foi possível guardar a mensagem.',
  bibleKeepPrivate: 'Guardar somente para mim',
  bibleShareFollowers: 'Compartilhar com seguidores',
  biblePublish: 'Publicar no feed',
  bibleSaving: 'Guardando…',
  biblePrivateHint: 'Só você verá esta mensagem no seu perfil.',
  biblePublicHint: 'A mensagem poderá aparecer no feed e no seu perfil, conforme a opção escolhida.',
  bibleRetry: 'Tentar novamente',
  bibleShortcutSub: 'Leia uma passagem explicada e escolha se quer guardar ou compartilhar.',
  profTabBible: 'Mensagens bíblicas',
  bibleEmpty: 'Você ainda não guardou nenhuma mensagem bíblica.',
  bibleEmptyCta: 'Ver a mensagem de hoje',
  bibleLabel: 'Mensagem bíblica de hoje de {name}',
});

Object.assign(dictionaries.en, {
  navBible: 'Biblical message',
  bibleEyebrow: 'A WORD FOR YOUR DAY',
  bibleTitle: 'A biblical message for you today',
  bibleSub: 'A passage explained in plain language, without reproducing the biblical text.',
  bibleCardLabel: 'A biblical message for today',
  bibleTodayLabel: 'For today',
  bibleNoQuote: 'Meaning explained · no verse reproduced',
  bibleNoQuoteLong: 'This message explains the passage and gives its reference. The biblical text is not reproduced.',
  bibleLoading: 'Preparing today’s message',
  bibleLoadingSub: 'The reference stays faithful while its meaning is explained carefully and without easy promises.',
  bibleLoadError: 'The message could not be prepared right now.',
  bibleSaveError: 'The message could not be saved.',
  bibleKeepPrivate: 'Keep it just for me',
  bibleShareFollowers: 'Share with followers',
  biblePublish: 'Publish to the feed',
  bibleSaving: 'Saving…',
  biblePrivateHint: 'Only you will see this message on your profile.',
  biblePublicHint: 'The message may appear in the feed and on your profile, according to your choice.',
  bibleRetry: 'Try again',
  bibleShortcutSub: 'Read an explained passage and choose whether to keep or share it.',
  profTabBible: 'Biblical messages',
  bibleEmpty: 'You have not saved a biblical message yet.',
  bibleEmptyCta: 'See today’s message',
  bibleLabel: 'Today’s biblical message from {name}',
});

Object.assign(dictionaries.es, {
  navBible: 'Mensaje bíblico',
  bibleEyebrow: 'UNA PALABRA PARA TU DÍA',
  bibleTitle: 'Mensaje bíblico de hoy para ti',
  bibleSub: 'Un pasaje explicado con palabras sencillas, sin reproducir el texto bíblico.',
  bibleCardLabel: 'Mensaje bíblico para hoy',
  bibleTodayLabel: 'Para llevar hoy',
  bibleNoQuote: 'Sentido explicado · sin reproducir el versículo',
  bibleNoQuoteLong: 'Este mensaje explica el sentido del pasaje e informa la referencia. El texto bíblico no se reproduce.',
  bibleLoading: 'Preparando tu mensaje de hoy',
  bibleLoadingSub: 'La referencia se mantiene fiel y su significado se explica con cuidado, sin promesas fáciles.',
  bibleLoadError: 'No fue posible preparar el mensaje ahora.',
  bibleSaveError: 'No fue posible guardar el mensaje.',
  bibleKeepPrivate: 'Guardar solo para mí',
  bibleShareFollowers: 'Compartir con seguidores',
  biblePublish: 'Publicar en el feed',
  bibleSaving: 'Guardando…',
  biblePrivateHint: 'Solo tú verás este mensaje en tu perfil.',
  biblePublicHint: 'El mensaje podrá aparecer en el feed y en tu perfil, según la opción elegida.',
  bibleRetry: 'Intentar de nuevo',
  bibleShortcutSub: 'Lee un pasaje explicado y elige si quieres guardarlo o compartirlo.',
  profTabBible: 'Mensajes bíblicos',
  bibleEmpty: 'Todavía no guardaste ningún mensaje bíblico.',
  bibleEmptyCta: 'Ver el mensaje de hoy',
  bibleLabel: 'Mensaje bíblico de hoy de {name}',
});
