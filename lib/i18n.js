...
dictionaries.pt.landHeadline = 'Todo mundo tem uma jornada.';
dictionaries.pt.landSub = 'Algo para enfrentar, mudar ou resolver.';
dictionaries.pt.heroDesc = 'O One Up Day ajuda você a transformar isso em um primeiro passo, registrar a caminhada e voltar sem perder sua história.';
dictionaries.pt.landCta = 'Começar minha jornada';
dictionaries.pt.heroOnde = 'Sem ranking. Sem perfeição. Um dia de cada vez.';
dictionaries.pt.landClose1 = 'A sua pode começar hoje.';
dictionaries.pt.landClose2 = 'Pequena, real, do seu jeito.';
dictionaries.pt.landCloseCta = 'Começar agora';

dictionaries.en.landHeadline = 'Everyone has a journey.';
dictionaries.en.landSub = 'Something to face, change, or solve.';
dictionaries.en.heroDesc = 'One Up Day helps you turn it into a first step, record the path, and come back without losing your story.';
dictionaries.en.landCta = 'Start my journey';
dictionaries.en.heroOnde = 'No ranking. No perfection. One day at a time.';
dictionaries.en.landClose1 = 'Yours can begin today.';
dictionaries.en.landClose2 = 'Small, real, and on your terms.';
dictionaries.en.landCloseCta = 'Start now';

dictionaries.es.landHeadline = 'Todos tienen una jornada.';
dictionaries.es.landSub = 'Algo que enfrentar, cambiar o resolver.';
dictionaries.es.heroDesc = 'One Up Day te ayuda a convertirlo en un primer paso, registrar el camino y volver sin perder tu historia.';
dictionaries.es.landCta = 'Comenzar mi jornada';
dictionaries.es.heroOnde = 'Sin ranking. Sin perfección. Un día a la vez.';
dictionaries.es.landClose1 = 'La tuya puede empezar hoy.';
dictionaries.es.landClose2 = 'Pequeña, real y a tu manera.';
dictionaries.es.landCloseCta = 'Comenzar ahora';
